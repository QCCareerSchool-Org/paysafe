...
export class Profile {
  ...
  setACHBankAccounts(achbankaccounts: ACHBankAccount): void { this.achbankaccounts = achbankaccounts; }
  getACHBankAccounts(): ACHBankAccount | undefined { return this.achbankaccounts; }
  setBACSBankAccounts(bacsbankaccounts: BACSBankAccount): void { this.bacsbankaccounts = bacsbankaccounts; }
  getBACSBankAccounts(): BACSBankAccount | undefined { return this.bacsbankaccounts; }
  setEFTBankAccounts(eftbankaccounts: EFTBankAccount): void { this.eftbankaccounts = eftbankaccounts; }
  getEFTBankAccounts(): EFTBankAccount | undefined { return this.eftbankaccounts; }
  setSEPABankAccounts(sepabankaccounts: SEPABankAccount): void { this.sepabankaccounts = sepabankaccounts; }
  getSEPABankAccounts(): SEPABankAccount | undefined { return this.sepabankaccounts; }
