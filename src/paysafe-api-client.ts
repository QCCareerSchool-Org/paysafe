...
export class PaysafeAPIClient {
  ...
  public get<T extends RequestObject>(uri: string, requestObject?: T): Promise<T> {
    return this.process('GET', uri, requestObject);
  }
  public post<T extends RequestObject>(uri: string, requestObject?: T): Promise<T> {
    return this.process('POST', uri, requestObject);
  }
  public put<T extends RequestObject>(uri: string, requestObject?: T): Promise<T> {
    return this.process('PUT', uri, requestObject);
  }
  public delete<T extends RequestObject>(uri: string, requestObject?: T): Promise<T> {
    return this.process('DELETE', uri, requestObject);
  }

  private process<T extends RequestObject>(method: 'GET' | 'POST' | 'PUT' | 'DELETE', uri: string, requestObject?: T): Promise<T> {
